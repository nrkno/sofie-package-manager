...
import { compareFileVersion, convertStatToVersion, unlinkIfExists } from './lib'
...
export async function workOnExpectation(exp: Expectation.MediaFileThumbnail): Promise<IWorkInProgress> {
	// Scan the media file
	...
	setImmediate(() => {
		;(async () => {
			...
			const sideCar: SideCar = {
				...
				fileVersionHash: fileVersionHash,
